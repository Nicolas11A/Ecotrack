...
import { createProfile, checkEmailExists } from '../Config/firebaseServices';
        ...
        <Card style={styles.Card}>
          <Card.Content>
            ...
            <Button
              ...
              style={styles.button}
            >
              <Text style={{ color: '#ffffff', fontWeight: 'bold' }}>Guardar Perfil</Text>
            </Button>
            <Button
              mode="text"
            ...
            >
              <Text style={styles.buttonTextLogIn}>Volver al Inicio de Sesión</Text>
            </Button>
          </Card.Content>
        </Card>
      </ScrollView>
